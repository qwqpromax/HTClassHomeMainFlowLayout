#
# Be sure to run `pod lib lint HTClassHomeMainFlowLayout.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'HTClassHomeMainFlowLayout'
  s.version          = '0.1.0'
  s.summary          = 'A short description of HTClassHomeMainFlowLayout.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'HTClassHomeMainFlowLayout' => ['HTClassHomeMainFlowLayout/Assets/*.png']
  # }
